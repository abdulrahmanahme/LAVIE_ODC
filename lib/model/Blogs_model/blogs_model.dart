...
class BlogDataModel {
  ...
  BlogDataModel({String? type, String? message, DatabBLOGS? data}) {
    if (type != null) {
      this._type = type;
    }
    if (message != null) {
  ...
  DatabBLOGS? get data => _data;
  set data(DatabBLOGS? data) => _data = data;

  BlogDataModel.fromJson(Map<String, dynamic> json) {
    _type = json['type'];
    _message = json['message'];
    _data = json['data'] != null ? new DatabBLOGS.fromJson(json['data']) : null;
  }
...
class DatabBLOGS {
  List<Plants>? _plants;
  List<SeedsBlogs>? _seeds;
  List<Tools>? _tools;

 DatabBLOGS({List<Plants>? plants, List<SeedsBlogs>? seeds, List<Tools>? tools}) {
    if (plants != null) {
      this._plants = plants;
    }
    if (seeds != null) {
  ...
  List<SeedsBlogs>? get seeds => _seeds;
  set seeds(List<SeedsBlogs>? seeds) => _seeds = seeds;
  List<Tools>? get tools => _tools;
  set tools(List<Tools>? tools) => _tools = tools;

  DatabBLOGS.fromJson(Map<String, dynamic> json) {
    if (json['plants'] != null) {
      _plants = <Plants>[];
    ...
    if (json['seeds'] != null) {
      ...
      json['seeds'].forEach((v) {
        _seeds!.add(new SeedsBlogs.fromJson(v));
      });
    }
    if (json['tools'] != null) {
      _tools = <Tools>[];
...
class SeedsBlogs {
  ...
  SeedsBlogs({String? seedId, String? name, String? description, String? imageUrl}) {
    if (seedId != null) {
      this._seedId = seedId;
    }
    if (name != null) {
  ...
  SeedsBlogs.fromJson(Map<String, dynamic> json) {
    _seedId = json['seedId'];
    _name = json['name'];
    _description = json['description'];
    _imageUrl = json['imageUrl'];
