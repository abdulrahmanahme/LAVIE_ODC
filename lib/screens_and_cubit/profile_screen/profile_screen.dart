...
var controllertEmail = TextEditingController();
...
class _GoogleScreenState extends State<GoogleScreen> {
  ...
  Widget build(BuildContext context) {
    return BlocConsumer<ProfileCubit, ProfileLavieStatus>(
                            ...
                            child: Column(
                              children: [
                                ...
                                Profile_button(
                                  ...
                                  press: () {
                                    cubit.changeNameAlertDialog(
                                      context,
                                      firstName: controllertname.text,
                                      formKey: formkey,
                                      nameController: controllertname,
                                ...
                                Profile_button(
                                  ...
                                  press: () {
                                    cubit.changeEmailAlertDialog(
                                      context,
                                      email: controllertEmail.text,
                                      formKey: formkey,
                                      eamilController: controllertEmail,
                                      loading: state is ProfileLoadingState,
                                    );
                                  },
